...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Realizada organização dos id das new Class e do código
		...
		Produto produto8 = new Produto(2, "Sonho", 5, 8.50, empresa);
		Produto produto9 = new Produto(3, "Croissant", 7, 6.50, empresa);
		Produto produto10 = new Produto(4, "Ché Gelado", 4, 5.50, empresa);

		Produto produto2 = new Produto(5, "Coturno", 10, 400.0, empresa2);
		Produto produto3 = new Produto(6, "Jaqueta Jeans", 15, 150.0, empresa2);
		Produto produto4 = new Produto(7, "Calça Sarja", 15, 150.0, empresa2);

		Produto produto5 = new Produto(8, "Prato feito - Frango", 10, 25.0, empresa3);
		Produto produto6 = new Produto(9, "Prato feito - Carne", 10, 25.0, empresa3);
		Produto produto7 = new Produto(10, "Suco Natural", 30, 10.0, empresa3);
	...
	public static void executar(List<Usuario> usuarios, List<Cliente> clientes, List<Empresa> empresas,
				...
				if (usuarioLogado.isEmpresa()) {
					...
					switch (escolha) {
						...
						case 1: {
							...
							System.out.println("************************************************************");
							break; // Adicinando break no switch
						}
						case 2: {
							System.out.println();
							System.out.println("************************************************************");
		...
		executar(usuarios, clientes, empresas, produtos, carrinho, vendas);
		sc.close(); // Add Close para finalizar o scanner
	}
